 ...
 * @author Diogo
 */
public class BuscarEditora extends javax.swing.JDialog {

    /**
     * Creates new form BuscarEditora
     */
    public BuscarEditora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarEditora dialog = new BuscarEditora(new javax.swing.JFrame(), true);
